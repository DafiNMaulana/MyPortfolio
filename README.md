...
<!--   <a href="#">
  ...
  <h3 align="center">Portfolio flat</h3>

  <p align="center">
    a portfolio build by bootstrap
<!--     <br />
...
<img src="https://github.com/DafiNMaulana/Best-README-Template/blob/main/images/Screenshot%20(5).png" alt="projects screenshot">
...
1. Clone the repo
   ```
   $git clone https://github.com/DafiNMaulana/MyPortfolio.git
   ```
